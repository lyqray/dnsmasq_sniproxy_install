...
install_dnsmasq(){
    ...
    download /tmp/proxy-domains-youtube.txt https://raw.githubusercontent.com/lyqray/dnsmasq_sniproxy_install/my/proxy-domains-youtube.txt
...
install_sniproxy(){
    ...
    download /tmp/sniproxy-domains.txt https://raw.githubusercontent.com/lyqray/dnsmasq_sniproxy_install/my/proxy-domains-youtube.txt
